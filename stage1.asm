...
;Incarca in memorie alt incarcator de la LBA 32
use16;Cod 16 bit
...
JMP	0810h:0000h;Transferam controlul codului incarcat
;_________________________________________________________________
...
stage2:;rutina de citire a unui sector de pe purtator intr-o zona de memorie
	...
	PUSH	0810h;transmitem prin stack
...
RET
;_________________________________________________________________
msg1	DB	"0x07C0:Stage 1.",10,13,00;Mesaj afisat la incarcarea LBA 0 de BIOS
msg2	DB	"0x07F0:Stage 1 copy.",10,13,00;Mesaj afisat cin copia programului primeshte controlul
